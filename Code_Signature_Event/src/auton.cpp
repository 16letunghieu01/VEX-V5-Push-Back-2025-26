...
void awp() {
    ...
    // pros::delay(150);
    // intakeMode = 0;
    // chassis.moveToPose(5, -6.5, 135, 1500, {.forwards = false, .minSpeed = 45}, false);
    ...
    chassis.moveToPoint(21, -47.25, 1000, {.forwards = false, .minSpeed = 90}, false);
    // goStraight(100, 900);
    // intakeMode = 4; 
    // pros::delay(150);
    intakeMode = 2;
...
void leftdescore7bloc() {
    ...
    chassis.moveToPoint(42, -47.25, 1650, {}, false);
    ...
    pros::delay(200);
    intakeMode = 1;
    chassis.moveToPoint(59.75, -47.25, 1200, {}, false);
    
    pros::delay(700);
    // intakeMode = 0;
    chassis.moveToPoint(23, -47.25, 1800, {.forwards = false, .minSpeed = 100});
    // pros::delay(700);
    chassis.turnToHeading(90, 300, {});
    resetposeskillxNorth(1);
    resetposeskillyEast(-1);
    ...
    chassis.moveToPoint(38, -47.25, 700, {}, true);
    descoreLeft.set_value(false);

    chassis.turnToHeading(30, 400, {}, true);
    chassis.moveToPoint(32, -57.5, 800, {.forwards = false}, true);
    chassis.turnToHeading(90, 500, {}, true);
    chassis.moveToPoint(11, -57.25, 900, {.forwards = false, .minSpeed = 90}, true);
...
void leftlongcenter2() {
    ...
    pros::delay(50);
    // pros::delay(400);
    chassis.moveToPoint(23, -47.25, 1100, {.forwards = false, .minSpeed = 100}, false);
    // intakeMode = 4; 
    // blockblock.set_value(false);
    // pros::delay(300);
    intakeMode = 2;
    ...
    chassis.swingToHeading(290, DriveSide::RIGHT, 1700, {.direction = AngularDirection::CCW_COUNTERCLOCKWISE}, true);
    // intakeMode = 1;
...
void rightdescore7bloc() {
    ...
    pros::delay(600);
    counterLoader.set_value(true);
    chassis.turnToHeading(45, 550, {}, true);
    chassis.moveToPoint(44, 47.75, 1300, {}, true);
    chassis.turnToHeading(90, 500, {}, true);
    // intakeMode = 4;
    // pros::delay(150);
    // intakeMode = 1;
    chassis.moveToPoint(59.75, 47.5, 1100, {}, false);
    chassis.turnToHeading(90, 400, {}, false);
    resetposeskillxNorth(1);
    resetposeskilly(1);
    pros::delay(50);
    ...
    // intakeMode = 0;
    chassis.moveToPose(23, 47.25, 90, 1400, {.forwards = false}, false);
    // pros::delay(600);
    intakeMode = 4;
    pros::delay(150);
    // // setStage(2);
    ...
    descoreLeft.set_value(false);
    chassis.moveToPoint(16, 37, 1670, {.forwards = false}, true);
    // chassis.moveToPoint(chassis.getPose().x, chassis.getPose().y, 6000, {.minSpeed = 120}, false);
    chassis.turnToHeading(70, 8000, {}, false);
}
